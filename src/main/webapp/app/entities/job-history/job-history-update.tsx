  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="nhipsterApp.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="nhipsterApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                >
                  <option value="FRENCH">{translate('nhipsterApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('nhipsterApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('nhipsterApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
